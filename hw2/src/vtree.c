...
int	user_file_list_supplied = 0;
    ...
    #ifdef LINUX
    struct option long_var_options[] = {
	...
	//Mehdad Zaman added
    #ifdef LINUX
    	while ((option = getopt_long(argc, argv, "dfh:iostqvVl", long_var_options, &op_index)) != EOF) {
   	#else
